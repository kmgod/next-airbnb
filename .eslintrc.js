module.exports = {
    ...
    "rules": {
        ...
        "@typesciript-eslint/no-unused-vars": "warn", //사용 안 한 변수는 경고
        ...
        "arrow-body-style": "off", //화살표 함수 안에 return을 사용할 수 없다
        "react-no-unescaped=entities": "off", //문자열 내에서 " ' > } 사용  
        "react-prop-types": "off", //proptypes를 사용하지 않는다
        "object-curly-newline": "off", //{ 다음 줄 바꿈을 사용하지 않는다
        "react/jsx-one-expression-per-line": "off", //한 라인에서 여러개의 JSX를 사용할 수 있다
        ...
        "react/jsx-filename-extension": [
            1,
            { extentions: [".js", ".jsx", ".tsx"] }, //jsx사용 가능한 확장자 설정
        ], 
        "import/extensions": [
            "error",
            "ignorePackages",
